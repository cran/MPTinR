...
Overall the FIA results clearly favor the two models including the inequality restrictions on $g$. At the level of the individual data, the restricted 2HTM seems to be preferred given as its summed FIA value is clearly smaller by around 64 and additionally it provided the best account for more participants (22/23 versus 17/18 for the unrestricted 2HTM). On the level of the aggregated data the pattern is the same although the difference between restricted and unrestricted 2HTM is minimal (0.16). 
